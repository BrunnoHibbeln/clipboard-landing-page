...
export default function HomePage() {
  return (
    <>
      <section className="flex flex-col items-center justify-center gap-9 xl:gap-14">
        <Image
          className="w-32 pb-12 pt-20 xl:w-44"
          src={logo}
          alt="Logo image"
        />
        <article className="flex flex-col gap-5">
          <h1 className="text-3xl font-semibold text-dark-gray xl:text-5xl">
        ...
        <section className="flex w-full flex-col justify-center gap-7 xl:flex-row">
          <IosButton />
          <MacButton />
        </section>
      </section>
